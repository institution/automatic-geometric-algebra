...
Mv02<C> operator*(Mv1<A> const& x, Mv1<B> const& y) {
    ...
    return Mv02<C>(((x[0] * y[0]) + (x[1] * y[1])), ((-1 * x[1] * y[0]) + (x[0] * y[1])));
}
...
Mv1<C> operator*(Mv02<A> const& x, Mv1<B> const& y) {
    ...
    return Mv1<C>(((x[0] * y[0]) + (x[1] * y[1])), ((-1 * x[1] * y[0]) + (x[0] * y[1])));
}
...
Mv2<C> operator^(Mv1<A> const& x, Mv1<B> const& y) {
    ...
    return Mv2<C>(((-1 * x[1] * y[0]) + (x[0] * y[1])));
}
...
Mv1<C> rotated(Mv1<A> const& x, Mv02<B> const& y) {
    ...
    return Mv1<C>(((2 * x[1] * y[0] * y[1]) + (x[0] * pow(y[0], 2)) + (-1 * x[0] * pow(y[1], 2))), ((-2 * x[0] * y[0] * y[1]) + (x[1] * pow(y[0], 2)) + (-1 * x[1] * pow(y[1], 2))));
}
